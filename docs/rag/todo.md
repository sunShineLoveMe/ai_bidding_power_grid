...
0. **泰昌历史标书复用 P1-02 文件级证据包已完成。** 基于当前真实 PostgreSQL 与 P0-02 基线只读重建 16 个稳定业务证据包，共 149 页：CPVC/MPP 检验报告 2、主要试验设备及校准资料 6、管理体系证书 3、营业执照 1、审计报告 3、项目业绩“合同 + 中标通知书”1。16 包页序完整、缺页 0、重页 0；21 个重复 PDF/关键页 JPG 仅作 rendition。职业健康安全证书因 2026-06-18 到期阻断，设备/体系证书有效期与审计年度保留条件门禁，资格预审结果因无独立原件记为缺口。P0-06 后续自动接收的 169 条历史 Word 候选尚未完成媒体提取和入库，因此未进入本轮证据包；辽宁招标资料和河北豪乾参考稿也均未进入。本轮未写数据库、未改 RAG/metadata/召回或 DOCX 选图；专项 30 项、后端全量 400 项及 2 个子测试通过，因此不重复执行召回和正式导出门禁。
